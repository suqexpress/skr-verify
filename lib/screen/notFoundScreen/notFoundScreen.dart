...
class ShopNotFound extends StatefulWidget {

  @override
  State<ShopNotFound> createState() => _ShopNotFoundState();
}

class _ShopNotFoundState extends State<ShopNotFound> {
